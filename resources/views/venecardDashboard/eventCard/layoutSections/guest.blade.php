                   ...
                   <td style="font-size: 0.8rem; line-height: 1.2rem; white-space: nowrap;">
                    ...
                    <td>
                        <div style="display: flex; flex-wrap: nowrap; gap: 0;">
                            <a href="{{ route('resendcard.resendwhatsappcard', encrypt($guest->id)) }}"
                                class="action-btn" title="Send WhatsApp"
                                onclick="confirmLinkAction(event, 'resend whatsApp card')">
                            ...
                            <a href="{{ route('resendcard.resendsmscard', encrypt($guest->id)) }}" class="action-btn"
                                title="Send SMS" onclick="confirmLinkAction(event, 'resend SMS card')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                    fill="currentColor" viewBox="0 0 16 16">
                                    <path
                                        d="M2 2a2 2 0 0 0-2 2v8.01A2 2 0 0 0 2 14h5.5a.5.5 0 0 0 0-1H2a1 1 0 0 1-.966-.741l5.64-3.471L8 9.583l7-4.2V8.5a.5.5 0 0 0 1 0V4a2 2 0 0 0-2-2zm3.708 6.208L1 11.105V5.383l4.708 2.825zM1 4.217V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v.217l-7 4.2z" />
                            ...
                            <a href="{{ route('downloadinviteecard', strrev($guest->invitation_code)) }}" class="action-btn"
                                title="download card" onclick="confirmLinkAction(event, 'download card')">
